-- Next AI Crew: PostgreSQL schema (converted from SQLite base-schema)
...
CREATE INDEX IF NOT EXISTS idx_project_review_decision_states_updated ON project_review_decision_states(updated_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_review_round_decision_states_updated ON review_round_decision_states(updated_at DESC);
...
-- RLS policies will be added in Day 2 (multi-tenancy sprint)
