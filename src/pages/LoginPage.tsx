    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-indigo-900">
      <div className="w-full max-w-md p-8 space-y-6">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-4xl font-bold text-white">Next AI Crew</h1>
        ...
        <div className="space-y-2.5">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white text-gray-800 font-medium rounded-lg hover:bg-gray-100 transition disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-gray-700 text-white font-medium rounded-lg hover:bg-gray-600 transition disabled:opacity-50"
          >
        ...
        <form onSubmit={handleEmailAuth} className="space-y-3">
          <input
            ...
            placeholder="Email"
            className="w-full px-4 py-3 bg-gray-800 border border-gray-600 text-white rounded-lg focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none placeholder-gray-500"
          />
          <input
            type="password"
            value={password}
        ...
        <p className="text-center text-gray-400 text-sm">
          {mode === "login" ? (
            <>
              New here?{" "}
              <button onClick={() => { setMode("signup"); setMessage(null); }} className="text-indigo-400 hover:text-indigo-300">
                Create an account
              </button>
            </>
          ) : (
            <>
              ...
              <button onClick={() => { setMode("login"); setMessage(null); }} className="text-indigo-400 hover:text-indigo-300">
                Sign in
              </button>
            </>
          )}
