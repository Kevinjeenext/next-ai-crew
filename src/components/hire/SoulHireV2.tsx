...
const PRESETS: SoulPreset[] = [
  ...
  // ── C-Level (7종) ──
  { id: "ceo", name: "CEO", display_name: "Chief Executive Officer", category: "C-Level", experience: "Expert", greeting_message: "기업의 비전과 전략을 총괄합니다. 의사결정, IR, 파트너십, 조직 리더십 문의하세요. 🎯", thumbnail_url: "/avatars/souls/soul_39_ceo.webp", skill_tags: ["전사전략", "투자유치", "파트너십", "조직리더십", "비전설계"], capabilities: [{ label: "전사 비전 및 중장기 전략 수립", supported: true }, { label: "C-Level 의사결정 지원 및 분석", supported: true }, { label: "IR/펀드레이징 전략 및 투자자 소통", supported: true }, { label: "크로스펑셔널 조정 및 우선순위 배분", supported: true }, { label: "직접 코드 개발", supported: false }], stats: { analysis: 94, judgment: 98, research: 90, writing: 88, reliability: 96, monitoring: 92 }, token_efficiency: "Balanced", token_pct: 50, match_score: 97, hired_by_count: 3200 },
  { id: "cfo", name: "CFO", display_name: "Chief Financial Officer", category: "C-Level", experience: "Expert", greeting_message: "기업의 재무 건전성과 지속 가능한 성장을 설계합니다. 투자, 예산, 번레이트 문의하세요. 📈", thumbnail_url: "/avatars/souls/soul_32_cfo.webp", skill_tags: ["재무전략", "투자유치", "P&L 분석", "세무·감사", "Unit Economics"], capabilities: [{ label: "재무 로드맵 및 시나리오 모델링", supported: true }, { label: "예산 편성 및 비용 최적화", supported: true }, { label: "IR 자료 및 밸류에이션 분석", supported: true }, { label: "세무 신고 및 컴플라이언스", supported: true }, { label: "직접 자금 이체", supported: false }], stats: { analysis: 96, judgment: 94, research: 88, writing: 82, reliability: 97, monitoring: 90 }, token_efficiency: "Balanced", token_pct: 45, match_score: 95, hired_by_count: 2100 },
  { id: "coo", name: "COO", display_name: "Chief Operating Officer", category: "C-Level", experience: "Expert", greeting_message: "운영 효율을 극대화하고 프로세스를 최적화합니다. 조직 운영, KPI, 고객 성공 문의하세요. ⚙️", thumbnail_url: "/avatars/souls/soul_33_coo.webp", skill_tags: ["운영전략", "OKR/KPI", "프로세스 최적화", "고객성공", "조직 스케일링"], capabilities: [{ label: "운영 프로세스 설계 및 SOP 수립", supported: true }, { label: "KPI 대시보드 및 성과 추적", supported: true }, { label: "고객 성공(CS) 전략 수립", supported: true }, { label: "조직 스케일업 계획", supported: true }, { label: "직접 고객 응대", supported: false }], stats: { analysis: 90, judgment: 95, research: 82, writing: 78, reliability: 96, monitoring: 94 }, token_efficiency: "Balanced", token_pct: 42, match_score: 93, hired_by_count: 1850 },
  { id: "cmo", name: "CMO", display_name: "Chief Marketing Officer", category: "C-Level", experience: "Expert", greeting_message: "브랜드 성장과 그로스 전략을 설계합니다. 마케팅, 퍼널, 컨텐츠 전략 문의하세요. 🚀", thumbnail_url: "/avatars/souls/soul_34_cmo.webp", skill_tags: ["그로스 전략", "퍼널 최적화", "컨텐츠 마케팅", "브랜딩", "LTV/CAC"], capabilities: [{ label: "그로스 전략 및 퍼널 설계", supported: true }, { label: "컨텐츠 마케팅 기획", supported: true }, { label: "LTV/CAC 분석 및 최적화", supported: true }, { label: "브랜드 가이드라인 수립", supported: true }, { label: "영상 제작/편집", supported: false }], stats: { analysis: 85, judgment: 88, research: 92, writing: 95, reliability: 84, monitoring: 80 }, token_efficiency: "Heavy", token_pct: 60, match_score: 92, hired_by_count: 2340 },
  { id: "cso", name: "CSO", display_name: "Chief Strategy Officer", category: "C-Level", experience: "Expert", greeting_message: "전략은 선택과 집중입니다. 시장 분석, 경쟁 전략, M&A 문의하세요. 🎯", thumbnail_url: "/avatars/souls/soul_35_cso.webp", skill_tags: ["사업전략", "경쟁분석", "M&A", "시장조사", "신사업 기획"], capabilities: [{ label: "시장 분석 및 경쟁사 벤치마킹", supported: true }, { label: "M&A 타겟 및 시너지 분석", supported: true }, { label: "신사업/신시장 진출 전략", supported: true }, { label: "중장기 로드맵 수립", supported: true }, { label: "법률 자문", supported: false }], stats: { analysis: 96, judgment: 94, research: 97, writing: 85, reliability: 90, monitoring: 78 }, token_efficiency: "Balanced", token_pct: 48, match_score: 94, hired_by_count: 1560 },
  { id: "cpo", name: "CPO", display_name: "Chief Product Officer", category: "C-Level", experience: "Expert", greeting_message: "제품은 사용자 문제 해결의 연속입니다. 로드맵, UX, PMF 문의하세요. 📦", thumbnail_url: "/avatars/souls/soul_36_cpo.webp", skill_tags: ["제품전략", "UX 리서치", "로드맵", "PMF", "데이터 기반 의사결정"], capabilities: [{ label: "제품 로드맵 및 우선순위 설정", supported: true }, { label: "UX 리서치 및 사용자 인터뷰", supported: true }, { label: "A/B 테스트 설계 및 분석", supported: true }, { label: "PMF 검증 프레임워크", supported: true }, { label: "코드 직접 개발", supported: false }], stats: { analysis: 92, judgment: 95, research: 94, writing: 88, reliability: 90, monitoring: 86 }, token_efficiency: "Balanced", token_pct: 50, match_score: 96, hired_by_count: 2780 },
  { id: "chro", name: "CHRO", display_name: "Chief Human Resources Officer", category: "C-Level", experience: "Expert", greeting_message: "사람이 곳 전략입니다. 채용, 조직문화, 인사제도 문의하세요. 👥", thumbnail_url: "/avatars/souls/soul_37_chro.webp", skill_tags: ["인사전략", "채용/온보딩", "조직문화", "보상체계", "성과평가"], capabilities: [{ label: "채용 파이프라인 설계", supported: true }, { label: "조직문화 진단 및 개선", supported: true }, { label: "보상체계 및 스톡옵션 설계", supported: true }, { label: "OKR 기반 성과평가 체계", supported: true }, { label: "노동법 소송 대리", supported: false }], stats: { analysis: 85, judgment: 92, research: 80, writing: 90, reliability: 88, monitoring: 82 }, token_efficiency: "Balanced", token_pct: 46, match_score: 91, hired_by_count: 1420 },
  { id: "clo", name: "CLO", display_name: "Chief Legal Officer", category: "C-Level", experience: "Expert", greeting_message: "법률은 비즈니스의 방패입니다. 계약, 규제, IP, 컴플라이언스 문의하세요. ⚖️", thumbnail_url: "/avatars/souls/soul_38_clo.webp", skill_tags: ["계약법", "IP/특허", "규제 대응", "컴플라이언스", "분쟁 해결"], capabilities: [{ label: "계약서 검토 및 작성", supported: true }, { label: "IP/특허 전략 수립", supported: true }, { label: "개인정보보호법 컴플라이언스", supported: true }, { label: "투자 계약 법률 검토", supported: true }, { label: "법정 소송 대리", supported: false }], stats: { analysis: 94, judgment: 96, research: 92, writing: 90, reliability: 95, monitoring: 74 }, token_efficiency: "Efficient", token_pct: 35, match_score: 90, hired_by_count: 1180 },
];

const CATEGORIES = ["전체", "Developer", "Designer", "Security", "Content", "DevOps", "Data", "Backend", "CS", "ML/AI", "Marketing", "매장관리", "세일즈", "노무", "세무", "회계", "학원관리", "학원교육", "C-Level"];
